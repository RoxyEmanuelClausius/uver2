...
module.exports = async (client, interaction, args) => {
    ...
    if (message == "information") {
        client.simpleEmbed({
            image: `https://cdn.discordapp.com/attachments/1046312392935620689/1116045267377074256/image.png`
    ...
    if (message == "rules") {
        client.simpleEmbed({
            image: `https://media.discordapp.net/attachments/1046312392935620689/1116045267377074256/image.png`
