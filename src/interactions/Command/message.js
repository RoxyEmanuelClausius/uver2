                            ...
                            fields: [
                                {
                                    ...
                                    value: `In the Uverseni Network team there is always a pleasant atmosphere and everyone is treated equally!`,
                                },
                                {
                ...
                if (message == "network") {
                    client.simpleEmbed({
                        ...
                        client.embed({
                            ...
                            desc: `Uverseni Network is a network that consists of 3 servers. Each server has its own function. One is for tech/coding/crypto and the other for support. We also have 1 extra server for ban appeals, read all information below`,
                            fields: [
                                {
                                    name: `💻┇Uverseni`,
